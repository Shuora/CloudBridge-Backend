...
public class InterfaceInfo implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
                ...
                && (this.getSdkId() == null ? other.getSdkId() == null : this.getSdkId().equals(other.getSdkId()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getSdkId() == null) ? 0 : getSdkId().hashCode());
        return result;
    }
